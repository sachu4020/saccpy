...
class DanceClassApp:
    def __init__(self, root):
        ...
        self.conn = sqlite3.connect('dance_class.db')
    ...
    def create_tables(self):
        """Create tables for students and payments if they don't exist"""
        self.cursor.execute("""
    ...
    def pay_fee(self):
        ...
        try:
            ...
            if student_id:
                ...
                self.cursor.execute("INSERT INTO payments (student_id, amount) VALUES (?, ?)", (student_id, amount))
                self.conn.commit()
    ...
    def apply_for_class(self):
        """Handle student application and store in database"""
        try:
            ...
            self.cursor.execute("INSERT INTO students (name, age, email, phone, gender) VALUES (?, ?, ?, ?, ?)", 
